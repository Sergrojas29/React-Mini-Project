...
const MultipleChoice = (props) => {
    ...
    function checkAnswer(e) {
        ...
        if (selected == answer._id) {
            ...
            setTimeout( () => e.target.setAttribute("style", "background-color:none;"), 200)
        }
    ...
    return (
        <div>
            ...
            <Typography variant="h2" gutterBottom
                sx={{ margin: '15px' }}>{activeQuestion && answer && answer.word}</Typography>

            <div id='area'>
                <Stack>
                    {activeQuestion && answer && choices.map((choice, index) => {
                        return (
                            <Button
                ...
                <Typography variant="h6" >Correct Answers : {counter}</Typography>
            </div>
        </div>
    )
